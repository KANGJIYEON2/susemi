...
━━━ 신용카드 공제 세부 구조 (조세특례제한법 §126의2) ━━━

card 섹션 작성 시 반드시 아래 세부율과 한도를 반영하세요:
...
- 전통시장: 40%
- 대중교통: 40%
- 도서/공연/영화/박물관 등 문화비: 30% (총급여 7천만원 이하만 적용)

【기본 공제한도】
- 총급여 7천만원 이하: 300만원
- 총급여 7천만원 초과: 250만원

【추가 공제한도】— 기본한도 소진 후 전통시장+대중교통+(문화비) 에서 추가
- 총급여 7천만원 이하: 300만원 (전통시장+대중교통+문화비 합산)
- 총급여 7천만원 초과: 200만원 (전통시장+대중교통만)

【공제 순서】— 25% 최저사용금액을 낮은 공제율 결제수단부터 차감 (공제 극대화)
  신용카드(15%) → 체크카드/현금영수증(30%) → 문화비(30%) → 전통시장/대중교통(40%)

card detail에서는:
- 사용자의 결제수단별 사용액을 구분해서 언급
- 체크카드/현금영수증이 신용카드보다 공제율이 2배인 점을 강조
- 전통시장/대중교통 40% 추가 공제 기회를 tips에 포함
- 총급여 기준 공제한도와 추가한도를 명시
